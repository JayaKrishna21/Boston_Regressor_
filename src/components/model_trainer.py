...
class ModelTrainerConfig:
    trained_model_file_path = os.path.join("artifacts","model.pkl") # creating a pickel file for model trainer
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            params = {
                ...
                'LassoRegression': {'alpha': [0.1, 1, 10, 100, 200, 500, 1000]},
                'ElasticNetRegression': {'alpha': [0.1, 1, 10, 100, 200, 500, 1000]},
                'DecisionTreeRegressor': {'max_depth':[3, 5, 7, 9, 11, 13]},
                'AdaBoost':{'estimator':[DecisionTreeRegressor()],'n_estimators': [10, 20, 50, 100, 200, 300,500,1000]},
                'GradientBoosting': {'n_estimators': [50, 100, 200,500], 'learning_rate': [0.05, 0.1, 0.2], 'max_depth': [3, 5, 7, 9]},
                'RandomForestRegression': {'n_estimators': [50, 100, 200,500], 'criterion': ['squared_error', 'absolute_error', 'friedman_mse','poisson'], 'max_depth':[3, 5, 7, 9, 11, 13]}
