...
# print(sys.path)
import os
# sys.path.append('D:/Codes/Projects/src')
# os.chdir('..')
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv("D:\\Codes\\Projects\\Boston_Regressor_\\notebook\\data\\HousingData.csv")
...
if __name__ == "__main__":
    ...
    train_arr, test_arr,_ = data_transformation.initiate_data_transformation(train_data, test_data) # train,test datasets are transformed into arrays using coLUmn transformer
